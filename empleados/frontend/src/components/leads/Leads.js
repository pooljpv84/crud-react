...
import { getTrabajador, deleteTrabajador, updateTrabajador } from '../../actions/trabajador';
                    ...
                    <tbody>
                        { this.props.trabajador.map(trabajador=>(
                            <tr key={trabajador.id}>
                                ...
                                <td>
                                    <button onClick={this.props.deleteTrabajador.bind(this, trabajador.id)} 
                                        className="btn btn-danger btn-sm">Borrar</button>
                                    {"   "}
                                    <button  onClick={this.props.updateTrabajador.bind(this, trabajador.id, trabajador)} className="btn btn-success btn-sm">Editar</button>
                                </td>
                            </tr>
                        )) }
                    </tbody>    
...
export default connect(mapStateToProps, { getTrabajador, deleteTrabajador, updateTrabajador }
    )(Leads);
